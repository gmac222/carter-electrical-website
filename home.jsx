...
const HERO_HEADLINES = {
  outcome: {
    ...
    strapline: (
      <>
        NICEIC-<span className="accent">approved<span style={{ color: 'var(--white)' }}>.</span></span>
      </>
    ),
      ...
      <div className="wrap">
        ...
        <div className="cta-aside">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', marginTop: '14px' }}>
            ...
            <div style={{ color: 'var(--muted-2)', fontSize: '0.85rem', textAlign: 'left' }}>
    ...
    <section className="section-y reveal">
      <div className="wrap">
        <div style={{ maxWidth: '800px' }}>
          <div className="eyebrow">Chester Electrical FAQs</div>
          <h2 className="h-2" style={{ marginTop: 10 }}>Frequently asked questions<span className="accent">.</span></h2>
          <p className="lede" style={{ marginTop: 16 }}>
            Real queries from Chester property owners, duty holders, and landlords regarding electrical installations and compliance.
          </p>
        </div>
