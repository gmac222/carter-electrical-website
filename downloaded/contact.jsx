  ...
  return (
    <>
      ...
      <section className="page-hero" style={{ paddingBottom: 60 }}>
        ...
        <div className="wrap">
          <div className="breadcrumbs"><a href="index.html">Home</a> · <span>Contact</span></div>
          <div className="page-hero-inner">
            <div>
              <div className="eyebrow" style={{ color: 'var(--accent)' }}>Discuss your project</div>
              <h1 className="h-1" style={{ marginTop: 18 }}>Tell us about the project.<br/><span style={{ color: 'var(--accent)' }}>We'll tell you what it takes.</span></h1>
              <p className="hero-sub" style={{ marginTop: 22 }}>A three-step conversation-starter. Not a hard sell. You'll hear back within one working day with the next sensible step.</p>
            </div>
            <div>
              <div className="circuit-rule" style={{ color: 'rgba(255,255,255,0.4)', marginBottom: 20 }}/>
              <dl style={{ display: 'grid', gap: 14, margin: 0 }}>
                <RowDark k="Direct line" v={<a href={CARTER.company.phoneHref} style={{ color: 'var(--accent)' }}>{CARTER.company.phone}</a>}/>
                <RowDark k="Email" v={<a href={`mailto:${CARTER.company.email}`}>{CARTER.company.email}</a>}/>
                <RowDark k="Hours" v="Mon–Fri 07:30–17:30"/>
                <RowDark k="Emergency" v={<span style={{ color: 'var(--accent)' }}>24 / 7 · call-out</span>}/>
              </dl>
            </div>
          </div>
        </div>
