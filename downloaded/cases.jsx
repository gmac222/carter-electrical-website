  ...
  return (
    <>
      ...
      <section className="page-hero">
        ...
        <div className="wrap">
          <div className="breadcrumbs"><a href="index.html">Home</a> · <span>Case Studies</span></div>
          <div className="page-hero-inner">
            <div>
              <div className="eyebrow" style={{ color: 'var(--accent)' }}>Selected projects</div>
              <h1 className="h-1" style={{ marginTop: 18 }}>Real installations.<br/><span style={{ color: 'var(--accent)' }}>Real sign-offs.</span></h1>
              <p className="hero-sub" style={{ marginTop: 22 }}>A record of work across commercial, hospitality, domestic and industrial — photographed and documented at handover.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="cs-hero">
        <div className="wrap">
          ...
          <div className="cs-visual" style={{ marginTop: 32 }}>
            <CarterPlaceholder metaTag="Commercial · Hospitality · Fit-out" titleCaption={`Old Dukes — ${c.location}`} year={c.year} hue={c.hue}/>
          </div>
        </div>
      </section>
      <section>
        <div className="wrap cs-body-grid">
          ...
          <div className="cs-prose">
            ...
            <div className="cs-gallery">
              <div className="tile wide"><CarterPlaceholder metaTag="Bar area · ground floor" titleCaption="Feature pendants, zoned dimming" year={c.year} hue={c.hue}/></div>
              <div className="tile tall"><CarterPlaceholder metaTag="Distribution" titleCaption="New sub-board install" year={c.year} hue={c.hue - 8}/></div>
              <div className="tile sq"><CarterPlaceholder metaTag="Containment" titleCaption="Concealed tray run" year={c.year} hue={c.hue + 6}/></div>
              <div className="tile sq"><CarterPlaceholder metaTag="Emergency lighting" titleCaption="Commissioning tests" year={c.year} hue={c.hue - 14}/></div>
              <div className="tile wide"><CarterPlaceholder metaTag="Upper floor · sports viewing" titleCaption="Dimmable scene lighting" year={c.year} hue={c.hue + 14}/></div>
            </div>
          </div>
        </div>
      </section>
