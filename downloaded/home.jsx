      ...
      <div className="wrap">
        ...
        <div className="services-grid">
          {CARTER.services.map((s) => (
            <a href={s.slug === 'commercial' ? 'commercial.html' : `services.html#${s.slug}`} key={s.num} className="service-card">
              <span className="sc-num">{s.num} / {String(CARTER.services.length).padStart(2,'0')}</span>
              <span className="sc-glyph" dangerouslySetInnerHTML={{ __html: CARTER.svg[s.icon] }} />
              <h3>{s.title}</h3>
