...
function CommercialDomesticDeep() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "eyebrow"
  }, "Local Capability & Sector Focus"), /*#__PURE__*/React.createElement("h2", {
    className: "h-2",
    style: {
      marginTop: 10
    }
  ...
  }, "Delivering precision electrical design, installation, and compliance for Chester\u2019s commercial premises and residential properties.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))',
      gap: 32
    }
  }, chester.commercialAngle && /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--white)',
      border: '1px solid var(--rule)',
      borderRadius: '20px',
  ...
  }), bullet))))), chester.domesticAngle && /*#__PURE__*/React.createElement("div", {
    style: {
      background: 'var(--white)',
      border: '1px solid var(--rule)',
      borderRadius: '20px',
  ...
  }, chester.domesticAngle)), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 28,
      padding: '20px',
      background: 'var(--bg-light)',
...
function FAQsSection() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "eyebrow"
  }, "Chester Electrical FAQs"), /*#__PURE__*/React.createElement("h2", {
    className: "h-2",
    style: {
      marginTop: 10
    }
  ...
  }, "Real queries from Chester property owners, duty holders, and landlords regarding electrical installations and compliance.")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 30,
      display: 'grid',
      gap: 1,
